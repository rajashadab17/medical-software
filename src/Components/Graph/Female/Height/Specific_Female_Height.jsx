...
const Specific_Female_Height = ({ Age, Height,Report, sentRemarks, forReportRemark }) => {
  ...
  for (let i = 0; i < pointindexes.length - 1; i++) {
    ...
    let BMIDiiference = Height_Array[i + 1] - Height_Array[i];
    ...
    <>
      <>
        ...
        >
          ...
          >
            <Button variant="contained" onClick={navigatetoWeight}>Show for Weight</Button>
            <Button variant="contained" onClick={navigatetoBMI}>Show for BMI</Button>
          </div> */}
          {Remarks && !Report && (
...
export default Specific_Female_Height;
