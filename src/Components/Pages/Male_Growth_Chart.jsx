...
const Male_Growth_Chart = () => {
  return (
    <>
      <FormLabel
        sx={{ textAlign: "center", width:"100%",margin: "20px 0"}}
      >
        Males, Ages 2-20 years
      </FormLabel>
      <TableContainer
        component={Paper}
        sx={{
          ...
          >
            {AgeInMonths.map((age, index) => (
              ...
              >
                ...
                <TableCell align="center">{Fifth_Percentile[index]}</TableCell>
                <TableCell align="center">{Tenth_Percentile[index]}</TableCell>
                <TableCell align="center">
                  {Twentfive_Percentile[index]}
                </TableCell>
                <TableCell align="center">{Fifty_Percentile[index]}</TableCell>
                <TableCell align="center">
                  {Seventy_Five_Percentile[index]}
                </TableCell>
                <TableCell align="center">
                  {Eighty_Five_Percentile[index]}
                </TableCell>
                <TableCell align="center">{Ninty_Percentile[index]}</TableCell>
                <TableCell align="center">
                  {Ninty_Five_Percentile[index]}
                </TableCell>
                <TableCell align="center">
...
export default Male_Growth_Chart;
